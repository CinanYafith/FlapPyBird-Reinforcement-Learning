"""
A set of functions to visualize the results of a neat-python run.

This is a slightly modified version of the visualize script from the neat-python examples.
"""
